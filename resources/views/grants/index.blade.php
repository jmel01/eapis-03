                ...
                <tr>
                    ...
                    <td>
                        @if ($grant->applicationOpen <= date('Y-m-d') && $grant->applicationClosed >= date('Y-m-d'))
                            ...
                            {{ date('d M. Y', strtotime($grant->applicationClosed)) }} <strong class="text-success">(Open)</strong>
                            @elseif ($grant->applicationOpen > date('Y-m-d'))
                            {{ date('d M. Y', strtotime($grant->applicationOpen)) }} to
                            {{ date('d M. Y', strtotime($grant->applicationClosed)) }} <strong class="text-info">(Upcoming)</strong>
                            @else
                            {{ date('d M. Y', strtotime($grant->applicationOpen)) }} to
                            {{ date('d M. Y', strtotime($grant->applicationClosed)) }} <strong class="text-danger">(Closed)</strong>
                            @endif
                    </td>
                    <td>
