...
@section('title', 'Payment To Grantee Management')
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Payment To Grantee for SY {{$grant->acadYr}}-{{$grant->acadYr+1}} ({{ App\Models\Psgc::getRegion($grant->region) }})</h3>
    </div>
    <div class="card-body">
