        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="lastName" type="text" value="{{old('lastName') ?? ($userProfile->lastName ?? '')}}" class="form-control {!! $errors->profile->first('lastName', 'is-invalid') !!}" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label>First Name</label>
                    <input name="firstName" type="text" value="{{old('firstName') ?? ($userProfile->firstName ?? '')}}" class="form-control {!! $errors->profile->first('firstName', 'is-invalid') !!}" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label>Middle Name</label>
                    <input name="middleName" type="text" value="{{old('middleName') ?? ($userProfile->middleName ?? '')}}" class="form-control {!! $errors->profile->first('middleName', 'is-invalid') !!}" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="birthdate" type="date" value="{{old('birthdate') ?? ($userProfile->birthdate ?? '')}}" class="form-control {!! $errors->profile->first('birthdate', 'is-invalid') !!}" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label>Place of Birth</label>
                    <input name="placeOfBirth" type="text" value="{{old('placeOfBirth') ?? ($userProfile->placeOfBirth ?? '')}}" class="form-control {!! $errors->profile->first('placeOfBirth', 'is-invalid') !!}" required>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input name="address" type="text" value="{{old('address') ?? ($userProfile->address ?? '')}}" class="form-control {!! $errors->profile->first('address', 'is-invalid') !!}" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="contactNumber" type="text" value="{{old('contactNumber') ?? ($userProfile->contactNumber ?? '')}}" class="form-control {!! $errors->profile->first('contactNumber', 'is-invalid') !!}" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
            ...
            <div class="col-md-12">
                <table class="table table-sm table-hover table-responsive-md">
                    ...
                    <tr>
                        ...
                        <td><input name="fatherName" type="text" value="{{old('fatherName') ?? ($userProfile->fatherName ?? '')}}" class="form-control  {!! $errors->profile->first('fatherName', 'is-invalid') !!}" required></td>
                        <td><input name="motherName" type="text" value="{{old('motherName') ?? ($userProfile->motherName ?? '')}}" class="form-control {!! $errors->profile->first('motherName', 'is-invalid') !!}" required></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">Address</td>
                        <td><input name="fatherAddress" type="text" value="{{old('fatherAddress') ?? ($userProfile->fatherAddress ?? '')}}" class="form-control {!! $errors->profile->first('fatherAddress', 'is-invalid') !!}" required></td>
                        <td><input name="motherAddress" type="text" value="{{old('motherAddress') ?? ($userProfile->motherAddress ?? '')}}" class="form-control {!! $errors->profile->first('motherAddress', 'is-invalid') !!}" required></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">Occupation</td>
                        <td><input name="fatherOccupation" type="text" value="{{old('fatherOccupation') ?? ($userProfile->fatherOccupation ?? '')}}" class="form-control {!! $errors->profile->first('fatherOccupation', 'is-invalid') !!}" required></td>
                        <td><input name="motherOccupation" type="text" value="{{old('motherOccupation') ?? ($userProfile->motherOccupation ?? '')}}" class="form-control {!! $errors->profile->first('motherOccupation', 'is-invalid') !!}" required></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">Office Address</td>
                        <td><input name="fatherOffice" type="text" value="{{old('fatherOffice') ?? ($userProfile->fatherOffice ?? '')}}" class="form-control {!! $errors->profile->first('fatherOffice', 'is-invalid') !!}" required></td>
                        <td><input name="motherOffice" type="text" value="{{old('motherOffice') ?? ($userProfile->motherOffice ?? '')}}" class="form-control {!! $errors->profile->first('motherOffice', 'is-invalid') !!}" required></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">Educational Attainment</td>
                        <td><input name="fatherEducation" type="text" value="{{old('fatherEducation') ?? ($userProfile->fatherEducation ?? '')}}" class="form-control {!! $errors->profile->first('fatherEducation', 'is-invalid') !!}" required></td>
                        <td><input name="motherEducation" type="text" value="{{old('motherEducation') ?? ($userProfile->motherEducation ?? '')}}" class="form-control {!! $errors->profile->first('motherEducation', 'is-invalid') !!}" required></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">Ethnolinguistic Group</td>
                        <td><input name="fatherEthnoGroup" type="text" value="{{old('fatherEthnoGroup') ?? ($userProfile->fatherEthnoGroup ?? '')}}" class="form-control {!! $errors->profile->first('fatherEthnoGroup', 'is-invalid') !!}" required></td>
                        <td><input name="motherEthnoGroup" type="text" value="{{old('motherEthnoGroup') ?? ($userProfile->motherEthnoGroup ?? '')}}" class="form-control {!! $errors->profile->first('motherEthnoGroup', 'is-invalid') !!}" required></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">Parent Annual Income</td>
                        <td><input name="fatherIncome" type="text" value="{{old('fatherIncome') ?? ($userProfile->fatherIncome ?? '')}}" class="form-control {!! $errors->profile->first('fatherIncome', 'is-invalid') !!}" required></td>
                        <td><input name="motherIncome" type="text" value="{{old('motherIncome') ?? ($userProfile->motherIncome ?? '')}}" class="form-control {!! $errors->profile->first('motherIncome', 'is-invalid') !!}" required></td>
                    </tr>
